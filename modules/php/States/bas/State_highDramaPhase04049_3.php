...
class State_highDramaPhase04049_3 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04049_3,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04049_3",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Point of Order') . clienttranslate(': ${you} must move your character to an adjacent City location:'),
            transitions: [
