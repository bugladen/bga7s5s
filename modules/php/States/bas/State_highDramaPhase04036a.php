...
class State_highDramaPhase04036a extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04036a,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04036a",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Ciphered Tome') . clienttranslate(': ${you} must choose a City location to move a Renown to:'),
            transitions: [
