...
class State_highDramaPhase04010_2 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04010_2,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04010_2",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Unravel the Thread') . clienttranslate(': ${you} may choose up to two cards to sink (Pass to sink none):'),
            transitions: [
