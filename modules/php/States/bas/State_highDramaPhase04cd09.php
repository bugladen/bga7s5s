...
class State_highDramaPhase04cd09 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04CD09,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04cd09",
            ...
            transitions: [
                ...
                "costChosen" => States::HIGH_DRAMA_PLAYER_TURN_04CD09_2,
            ],
