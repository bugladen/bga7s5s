...
class State_highDramaPhase04039 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04039,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04039",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Rapsodia') . clienttranslate(': ${you} must choose a City location you control to lose control of:'),
            transitions: [
