...
class State_highDramaPhase04036b extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04036b,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04036b",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Ciphered Tome') . clienttranslate(': ${you} must choose a location with more Renown:'),
            transitions: [
