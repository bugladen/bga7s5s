...
class State_highDramaPhase04cd01 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_04CD01,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase04cd01",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Penya') . clienttranslate(': ${you} must choose an adjacent City location to move the equipped character to:'),
            transitions: [
