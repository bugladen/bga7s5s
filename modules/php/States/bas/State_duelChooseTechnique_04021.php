...
class State_duelChooseTechnique_04021 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::DUEL_CHOOSE_TECHNIQUE_04021,
            type: StateType::ACTIVE_PLAYER,
            name: "duelChooseTechnique_04021",

            description: clienttranslate('${actplayer} is choosing a Technique to copy.'),
            descriptionMyTurn: clienttranslate('Aimée Barrere') . clienttranslate(': ${you} must choose a Technique on your other Musketeer to copy:'),
            transitions: [
