...
class State_highDramaPhase03056_2 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_03056_2,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase03056_2",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Astute') . clienttranslate(': ${you} must choose a location to move a Renown to:'),
            transitions: [
