...
class State_highDramaPhase03009 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_03009,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase03009",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Follow the Thread') . clienttranslate(': ${you} must choose an adjacent location:'),
            transitions: [
