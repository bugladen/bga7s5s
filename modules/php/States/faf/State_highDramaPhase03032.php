...
class State_highDramaPhase03032 extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_03032,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase03032",

            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Bloody Entrance') . clienttranslate(': ${you} must choose a destination location:'),
            transitions: [
