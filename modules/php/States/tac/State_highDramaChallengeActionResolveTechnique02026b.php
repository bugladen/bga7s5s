...
class State_highDramaChallengeActionResolveTechnique02026b extends GameState
{
    ...
    )
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_CHALLENGE_ACTION_RESOLVE_TECHNIQUE_02026b,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaChallengeActionResolveTechnique_02026b",
            ...
            transitions: [
                ...
                // Pre-Accept RESOLVE_TECHNIQUE_EVENTS would apply destroy even on Refuse.
