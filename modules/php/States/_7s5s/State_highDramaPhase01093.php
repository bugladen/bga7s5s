...
class State_highDramaPhase01093 extends GameState
{
    ...
    ) 
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_01093,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase01093",

            // optional
            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Maya De La Rioja') . clienttranslate(': ${you} must choose a location to move to:'),
            transitions: [
