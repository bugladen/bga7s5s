...
class State_highDramaPhase01106_2 extends GameState
{
    ...
    ) 
    {
        parent::__construct($game,
            id: States::HIGH_DRAMA_PLAYER_TURN_01106_2,
            type: StateType::ACTIVE_PLAYER,
            name: "highDramaPhase01106_2",

            // optional
            description: clienttranslate('${actplayer} is choosing options to perform an Action.'),
            descriptionMyTurn: clienttranslate('Improvising') . clienttranslate(': ${you} must choose a Risk to play from chosen discard pile:'),
            transitions: [
