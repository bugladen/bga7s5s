...
class _01019 extends Brute implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Brute (Brutes do not count against your Crew Cap, go to the discard pile when destroyed, and are discarded from play at the end of the day.)</p><p><b>City Action:</b> Destroy Buratino • Wound target character at that location.</p>");
