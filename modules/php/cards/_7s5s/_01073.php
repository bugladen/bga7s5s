...
class _01073 extends FactionAttachment implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>May only equip to your Duelist.</p><p><b>City Action:</b> Engage the equipped performer • They issue a [Finesse] challenge to target opposing character.</p>");
