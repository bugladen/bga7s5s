...
class _01095 extends Character implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Traits = [
            clienttranslate("Dockmaster"),
            clienttranslate("Numa")
        ];

        $this->Text = clienttranslate("<p>While Patricia is at [The City Docks], if she is en garde, she cannot be issued challenges.</p><p><b>City Action:</b> If Patricia is at [The City Docks] • Claim it.</p><p><b>City Action:</b> If Patricia is at [The City Docks], engage her • If you are the first player, draw a card. Otherwise, each opponent discards a card.</p>");
