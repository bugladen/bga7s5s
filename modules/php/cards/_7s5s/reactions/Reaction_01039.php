...
class Reaction_01039 extends CardReaction
{
    ...
    public function handleEvent(Event $event)
    {
        ...
        if ($event instanceof EventAttachmentEquipped && $this->isAvailable())
        {
            ...
            if ($event->characterId == $philip->Id && ! $attachment->FakeAttachment)
            {
    ...
    public function performReaction(Game $game, int $state, string $internalId, string $reactionId): void
    {
        ...
        if ($reactionId != "pass")
        {
            ...
            $event = EventFactory::createCardMovingEvent($philip->ControllerId, $philip->Id, $philip->Location, $locationName, $engage=false, $philip->Id, $this->Id);
