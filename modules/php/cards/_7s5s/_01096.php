...
class _01096 extends Character implements IHasActions, IHasTechniques
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p><b>City Action:</b> Target an adjacent enemy character equipped with attachment • Move Ratón to their location.</p><p><b>Technique:</b> At the end of the adversary's next round, if they were not wounded during it, take control of target attachment on them and equip it to Ratón. (There are no adversaries if the challenge is refused.)</p>");
