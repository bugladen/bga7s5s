...
class _01037 extends Character implements IHasReactions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Edeline gains +1 [Influence] for each character at this location.</p><p><b>Reaction:</b> After a duel, target an engaged participant at an adjacent location • Move them to this location.</p>");
