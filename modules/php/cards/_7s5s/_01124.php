...
class _01124 extends Character implements IHasActions, IHasReactions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = "<p>Sorcerer Action: Engage Ved'ma • Play target Sorcery in your discard pile as if it was in your hand. After it resolves, send it to The Locker.</p><p>Reaction: After you play a Sorcery from your hand that engaged Ved'ma • En garde her.</p>";
