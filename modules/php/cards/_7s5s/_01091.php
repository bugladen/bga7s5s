...
class _01091 extends Character implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = "<p>City Action: Target a character at this location, or two characters instead by discarding a card • Heal a wound from each targeted character.</p>";
