...
class _01197 extends CityCharacter implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Negotiable (You may parley when paying for this card.)</p><p>When Kalla equips an attachment, it has -1 cost.</p><p><b>Action:</b> Move an equipped attachment between two of your characters at this location.</p>");
