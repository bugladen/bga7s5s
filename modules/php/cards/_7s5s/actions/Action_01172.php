...
class Action_01172 extends RiskAction implements ISorcererAbility, IAbilityThatTargetsCharacters, IAbilityThatTargetsCards
{
    ...
    public function actFromActionWithId(Game $game, int $state, string $stateName, int $id): void
    {
        ...
        if ($state == States::HIGH_DRAMA_PLAYER_TURN_01172)
        {
            ...
            $moveEvent = EventFactory::createCardMovingEvent($performer->ControllerId, $target->Id, $target->Location, $performer->Location, false, $owner->Id);
