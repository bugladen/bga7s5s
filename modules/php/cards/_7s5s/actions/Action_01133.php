...
class Action_01133 extends RiskAction implements ISorcererAbility, IAbilityThatTargetsCharacters
{
    ...
    public function actFromActionWithIds(Game $game, int $state, string $stateName, array $ids): void
    {
        ...
        if ($state == States::HIGH_DRAMA_PLAYER_TURN_01133)
        {
            ...
            $sorcererAbilityPlayedEvent = EventFactory::createSorcererAbilityPlayedEvent($owner->ControllerId, $owner->Id, $this->Id, $performer->Id, $performer->Id, $performer->Location);
