...
class _01092 extends Character implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>When a character opposing Makepeace equips a card, it gains +1 cost.</p><p><b>City Action:</b> Target an opposing engaged character with equal or less [Influence] • Move them Home.</p>");
