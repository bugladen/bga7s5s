...
class _01050 extends FactionAttachment implements IHasTechniques
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>May only equip to your character that has a Weapon. (If they lose their Weapon, destroy this card.)</p><p><b>Technique:</b> -1 [Thrust] • Wound the adversary. (Must have minimum of 1 Thrust)</p>");
