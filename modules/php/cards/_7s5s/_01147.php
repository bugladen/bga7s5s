...
class _01147 extends Scheme implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = "<p>Add a Renown to [The Grand Bazaar] and [The Forums].</p><p>Reveal cards from the City Deck until you find an attachment. Add it to [The Grand Bazaar]. Sink the rest.</p><p>[BAR]</p><p>City Action: Your performer equips target attachment from [The Grand Bazaar]. If they are at [The Grand Bazaar], it has -1 cost.</p>";
