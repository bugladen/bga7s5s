...
class _01174 extends Risk implements IHasActions, IRiskThatTargetsCharacters
{
    use ActionTrait;
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p><b>Action:</b> Destroy target non-Unique attachment.</p>");
