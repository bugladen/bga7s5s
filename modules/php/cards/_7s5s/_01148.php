...
class _01148 extends Scheme implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Add a Renown to [The City Docks] and [The Grand Bazaar].</p><hr><p><b>City Action:</b> Target a Mercenary opposing your performer • You may discard any number of cards. Engage or wound that character for each card discarded this way.</p>");
