...
class _01072 extends Scheme
{
    ...
    public function handleEvent(Event $event)
    {
        ...
        if ($event instanceof EventResolveScheme && $event->scheme->Id == $this->Id) {
            ...
            $event->theah->game->notifyAllPlayers("message", clienttranslate('<strong>${scheme_name}</strong> now resolves. ${player_name} must choose a city location with no Reknown to place reknown onto.'), [
                'i18n' => ['scheme_name'],
