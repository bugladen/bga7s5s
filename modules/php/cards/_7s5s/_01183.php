...
class _01183 extends CityEventCard
{
    public function __construct()
    {
        ...
        $this->Text = "<p>During a duel, participants at this location have -1[parry] on their combat cards.</p><p>Pressures at this location also add [Combat]. (Pressures using Combat do not add Combat again.)</p>";
