...
class _01125 extends Scheme
{
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>You may add a Renown to any location. If you do not, move a Renown to an adjacent location.</p><p>Choose an enemy character. When the chosen character is your adversary, your combat cards gain +1 thrust.</p><hr><p><b>Reaction:</b> At the beginning of Dusk, if the chosen character is at Home • Gain a Renown.</p>");
