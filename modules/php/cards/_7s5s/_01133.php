...
class _01133 extends Risk implements IHasActions, IHasReactions, IHasManeuvers, IRiskThatTargetsCharacters
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p><b>Sorcerer Action:</b> You may engage your performer. if you do, ignore all costs • Move target character you control from this location to any other one.</p><p><b>Sorcerer Maneuver:</b> Move both participants to an adjacent location. (The duel continues.)</p>");
