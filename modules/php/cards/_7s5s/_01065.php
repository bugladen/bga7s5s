...
class _01065 extends Character implements IHasReactions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Your other Musketeers at Henri's location cannot be moved by an opponent's abilities.</p><p><b>Reaction:</b> When Henri issues a challenge, engage his equipped Weapon • Target character cannot intervene.</p>");
