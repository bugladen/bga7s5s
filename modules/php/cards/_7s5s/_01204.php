...
class _01204 extends CityAttachment implements IHasTechniques
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>This card cannot be destroyed or moved from the equipped character.</p><p><b>Technique:</b> Wound the equipped performer • During the adversary's next round, their combat card has -2 [Parry].</p>");
