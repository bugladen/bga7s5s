...
class _01020 extends Brute implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = "<p>Brute (Brutes do not count against your Crew Cap, go to the discard pile when destroyed, and are discarded from play at the end of the day.)</p><p>City Action: Destroy Dante • Move target character to that location.</p>";
