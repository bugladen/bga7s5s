...
class _01045 extends Scheme implements IHasReactions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Add a Renown to [The City Forum].</p><p>Put target Mercenary from the City Deck discard pile on top of the City Deck.</p><hr><p>Your Leader gains +1[Influence] while parleying with a Mercenary.</p><p><b>Reaction:</b> At the end of High Drama, if there are no available Mercenaries and attachments • Gain a Renown.</p>");
    ...
    public function handleEvent(Event $event)
    {
        ...
        if ($event instanceof EventResolveScheme && $event->scheme->Id == $this->Id) {
            ...
            $reknown = EventFactory::createRenownAddedToLocationEvent($event->playerId, Game::LOCATION_CITY_FORUM, 1, $this->getInjectCode());
