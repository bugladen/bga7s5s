...
class _01149 extends Scheme implements IHasActions
{
    ...
    public function __construct()
    {
        ...
        $this->Text = clienttranslate("<p>Add a Renown to [The City Docks] and [The Grand Bazaar]. Then, add a City Card to [The City Docks].</p><hr><p><b>City Action:</b> If [The City Docks] has no City Cards or only events • Move your performer from [The City Docks] to any City location.</p>");
    ...
    public function handleEvent(Event $event)
    {
        ...
        if ($event instanceof EventResolveScheme && $event->scheme->Id == $this->Id) {
            ...
            $event->theah->game->notify->all("message", clienttranslate('${scheme_inject_code} now resolves.  Renown will be added to The Docks and The Grand Bazaar.  A new City Card will be added to The Docks.'), [
