...
class _01149 extends Scheme
{
    ...
    public function handleEvent($event)
    {
        ...
        if ($event instanceof EventResolveScheme && $event->scheme->Id == $this->Id) {
            ...
            $event->theah->game->notifyAllPlayers("schemeResolvesMessage", clienttranslate('${scheme_name} now resolves.  Reknown will be added to The Docks and The Grand Bazaar.  A new City Card will be added to The Docks.'), [
