...
class Action_01194 extends CharacterAction
{
    ...
    {
        parent::__construct();
        $this->Name = "Adelheide: Wound target opposing character";
        $this->ShortName = "Wound target opposing character";
    }
    ...
    public function handleEvent(Event $event)
    {
        ...
        {
            $transition = EventFactory::createTransitionEvent($event->playerId, $this->OwnerId, "01194");
    ...
    { 
        ...
        if ($state == States::HIGH_DRAMA_PLAYER_TURN_01194_2)
        {
            ...
            $woundEvent = EventFactory::createCharacterWoundedEvent($targetCharacter->Id, $adelheide->Id, 1, "Adelheide Schmidt's Action");
