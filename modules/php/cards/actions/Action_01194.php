...
class Action_01194 extends CharacterAction
{
    ...
    {
        parent::__construct();
        $this->Name = "Wound target opposing character";
    }
    ...
    { 
        ...
        if ($state == States::HIGH_DRAMA_PLAYER_TURN_01194_2)
        {
            ...
            $woundEvent = EventFactory::createCharacterWoundedEvent($targetCharacter->Id, $adelheide->Id, 1,  $game->translate("Adelheide Schmidt's Action"));
