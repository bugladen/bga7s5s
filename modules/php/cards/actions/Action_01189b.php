...
class Action_01189b extends EventCityAction
{
    public function __construct()
    {
        ...
        $this->Name = "Point of Opportunity: Move Reknown To Adjacent Location";
        $this->ShortName = "Move Reknown To Adjacent Location";
    ...
    public function handleEvent(Event $event)
    {
        ...
        {
            $transition = EventFactory::createTransitionEvent($event->playerId, $this->OwnerId, "01189b");
