...
class Reaction_01199 extends CardReaction
{
    ...
    public function getReactionButtonProperties(Theah $theah): array
    {
        ...
        $array[] = $this->createButtonProperty($theah->game, 'Heal Wound', 'healWound');
    ...
    public function performReaction(Game $game, int $state, string $internalId, string $reactionId): void
    {
        ...
        if ($reactionId == 'healWound')
        {
            ...
            $event = EventFactory::createCharacterHealedEvent($this->TargetCharacterId, $takama->Id, 1, $game->translate("Takama Siad"));
