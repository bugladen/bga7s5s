...
class Maneuver_02059 extends Maneuver
{
    public function __construct()
    {
        parent::__construct();

        $this->Name = clienttranslate("3+ Finesse: +1 Riposte");
    }
    ...
    public function isAvailableToPlayer(int $playerId, Theah $theah): bool
    {
        ...
        return $actor->ModifiedFinesse >= 3;
    }
    ...
    public function handleEvent(Event $event)
    {
        ...
        if ($event instanceof EventDuelCalculateManeuverValues && $event->maneuverId == $this->Id)
        {
            ...
            $event->riposte += 1;
            $event->explanations[] = sprintf($event->theah->game->translate("%s: Maneuver [%s] adds +1 Riposte."), $owner->getInjectCode(), $this->Name);
        }
    }
}
