...
class _02011 extends Character implements IHasActions, IHasReactions, IHasTechniques, IHasManeuvers
{
    ...
    public function __construct()
    {
        ...
        $this->Text = "<p><b>Reaction:</b> When Katain performs an ability on a <b>Ranged</b> card, discard a card • Copy the effects.</p><p><b>Technique:</b> Engage Katain's equipped <b>Ranged Weapon</b> • +1[parry].</p>";
