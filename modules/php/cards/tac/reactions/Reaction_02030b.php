...
class Reaction_02030b extends RiskReaction
{
    ...
    public function __construct()
    {
        ...
        $this->Name = clienttranslate("Gain Musketeer when challenge issued");
    }

    public function getReactionDescription(Theah $theah): string
    {
        return parent::getReactionDescription($theah) . $theah->game->translate('A challenge has been issued. ${you} may choose a character to gain Musketeer until the action resolves: ');
    }
