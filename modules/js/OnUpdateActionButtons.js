        ...
        if(this.isCurrentPlayerActive())
        {
            ...
            if ( ! document.getElementById('deck-picker'))
            {
                ...
                dojo.place( this.format_block( 'jstpl_deck_picker', {
                    banner_description: _('Select a Starter Deck to play with using the buttons above.<br>Explore the available Factions using the buttons below.<br>Select the <strong>Custom</strong> button below to paste a custom deck code.<br>Click <strong>Select This Deck</strong> to choose selected Faction or Custom Deck.'),
