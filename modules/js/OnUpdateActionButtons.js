        ...
        if(this.isCurrentPlayerActive())
        {
            ...
            if ( ! document.getElementById('deck-picker'))
            {
                ...
                dojo.place( this.format_block( 'jstpl_deck_picker', {
                    banner_description: _('Select a Core Starter Deck to play with using the Quick buttons above, or...<br>Explore existing Starter Decks using the buttons below, or...<br>Select the <strong>Custom deck Code</strong> button below to paste a custom deck code.<p>When ready, click <strong>Confirm Deck</strong> to confirm selected Deck.</p>'),
