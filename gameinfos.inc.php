...
$gameinfos = [
    ...
    'game_name' => "7th Sea: City of Five Sails",

    // Game publisher (use empty string if there is no publisher)
    'publisher' => 'Pinebox Entertainment',

    // Url of game publisher website
    'publisher_website' => 'http://www.pineboxentertainment.com/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 36701,
    ...
    'tie_breaker_description' => totranslate("Number of controlled Locations, then most Influence, then Leader with the fewest Wounds (calculated as 20 - Wounds.)"),
    ...
    'player_colors' => ["982fff", "ff0000", "008000", "0000ff", "773300"],
    ...
    //better detect warnings, that are usually source of undetected bugs
