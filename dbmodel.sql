...
CREATE TABLE IF NOT EXISTS `duel_round` (
  ...
  `challenger_threat_is_lethal` tinyint NULL,
  `defender_threat_is_lethal` tinyint NULL,
...
CREATE TABLE IF NOT EXISTS `duel_round_combat_card` (
  `duel_round_combat_card_id` smallint unsigned NOT NULL AUTO_INCREMENT,
  `duel_id` tinyint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `duel_round_technique` (
  `duel_round_technique_id` smallint unsigned NOT NULL AUTO_INCREMENT,
  `duel_id` tinyint unsigned NOT NULL,
  `round` smallint unsigned NOT NULL,
