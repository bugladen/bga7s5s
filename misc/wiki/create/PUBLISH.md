...
cd wiki-tmp
git add Implementing-A-Character-Card.md Character-Guide-*.md Implementing-A-Leader-Card.md Leader-Guide-*.md
git commit -m "Update Character and Leader create guides."
git push origin master
```

`Home.md` already links [[Implementing a Character Card]] and [[Implementing a Leader Card]] — leave it alone unless those entry points change.
