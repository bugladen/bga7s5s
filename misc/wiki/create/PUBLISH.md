...
cd wiki-tmp
git add Implementing-A-Character-Card.md Character-Guide-*.md Implementing-A-Leader-Card.md Leader-Guide-*.md Implementing-A-Scheme-Card.md Scheme-Guide-*.md Implementing-A-CityCharacter-Card.md CityCharacter-Guide-*.md
git commit -m "Update Character, Leader, Scheme, and CityCharacter create guides."
git push origin master
```

`Home.md` should link [[Implementing a Character Card]], [[Implementing a Leader Card]], [[Implementing a Scheme Card]], and [[Implementing a CityCharacter Card]]. Update Home when you add a new entry-point guide.
