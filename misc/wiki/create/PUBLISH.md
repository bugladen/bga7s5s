...
cd wiki-tmp
git add Implementing-A-Character-Card.md Character-Guide-*.md Implementing-A-Leader-Card.md Leader-Guide-*.md Implementing-A-Scheme-Card.md Scheme-Guide-*.md Implementing-A-CityCharacter-Card.md CityCharacter-Guide-*.md Implementing-A-FactionAttachment-Card.md FactionAttachment-Guide-*.md
git commit -m "Update Character, Leader, Scheme, CityCharacter, and FactionAttachment create guides."
git push origin master
```

`Home.md` should link [[Implementing a Character Card]], [[Implementing a Leader Card]], [[Implementing a Scheme Card]], [[Implementing a CityCharacter Card]], and [[Implementing a FactionAttachment Card]]. Update Home when you add a new entry-point guide.
