...
$machinestates += [
    ...
    States::PLANNING_PHASE_RESOLVE_SCHEMES_01016 => [
        ...
        "description" => clienttranslate('Plans Within Plans') . clienttranslate(': ${actplayer} must choose two city locations to place Renown onto.'),
        "descriptionmyturn" => clienttranslate('Plans Within Plans') . clienttranslate(': ${you} must choose two city locations to place Renown onto:'),
        "type" => "activeplayer",
        "args" => "argsEmpty",
        "possibleactions" => [
    ...
    States::PLANNING_PHASE_RESOLVE_SCHEMES_01071 => [
        ...
        "description" => clienttranslate('Épée Sanglante') . clienttranslate(': ${actplayer} must choose a city location to place Renown onto.'),
        "descriptionmyturn" => clienttranslate('Épée Sanglante') . clienttranslate(': ${you} must choose a city location to place Renown onto:'),
        "type" => "activeplayer",
        "args" => "argsEmpty",
        "possibleactions" => [
            "actCityLocationsForReknownSelected", 
    ...
    States::PLANNING_PHASE_RESOLVE_SCHEMES_01072 => [
        ...
        "description" => clienttranslate('Réputation Méritée') . clienttranslate(': ${actplayer} must choose a city location to place Renown onto that doesn\'t have any.'),
        "descriptionmyturn" => clienttranslate('Réputation Méritée') . clienttranslate(': ${you} must choose a city location to place Renown onto that doesn\'t have any:'),
        "type" => "activeplayer",
        "args" => "argsEmpty",
        "possibleactions" => [
    ...
    States::PLANNING_PHASE_RESOLVE_SCHEMES_01143 => [
        ...
        "descriptionmyturn" => clienttranslate('Contempt and Hatred') . clienttranslate(': ${you} may choose a city location to place Renown onto:'),
        "type" => "activeplayer",
        "args" => "argsEmpty",
        "possibleactions" => [
            "actPass",
    ...
    States::PLANNING_PHASE_RESOLVE_SCHEMES_01150 => [
        ...
        "description" => clienttranslate('Parley Gone Wrong') . clienttranslate(': ${actplayer} may choose a city location to move a Renown from.'),
        "descriptionmyturn" => clienttranslate('Parley Gone Wrong') . clienttranslate(': ${you} may choose a city location to move a Renown from:'),
        "type" => "activeplayer",
        "args" => "argsEmpty",
        "possibleactions" => [
            "actFromCardWithLocations", 
    ...
    States::PLANNING_PHASE_RESOLVE_SCHEMES_01152 => [
        ...
        States::PLANNING_PHASE_RESOLVE_SCHEMES_01152_2 => [
            ...
            "description" => clienttranslate('Until Morale Improves') . clienttranslate(': ${actplayer} must choose a City Location to move a Renown FROM, if able.'),
            "descriptionmyturn" => clienttranslate('Until Morale Improves') . clienttranslate(': ${you} must choose a City Location to move a Renown FROM, if able: '),
            "type" => "activeplayer",
            "args" => "argsEmpty",
            "possibleactions" => [
                "actFromCardWithLocations",
    ...
    States::HIGH_DRAMA_PLAYER_TURN_01034_2 => [
        ...
        "descriptionmyturn" => clienttranslate('Wrath of the Don') . clienttranslate(': ${you} must choose to Engage target character or Performer will En garde:'),
        "type" => "activeplayer",
        "args" => "argsForState",
        "possibleactions" => [
            "actFromCardWithId",
    ...
    States::HIGH_DRAMA_PLAYER_TURN_01189a => [
        ...
        "description" => clienttranslate('${actplayer} is choosing options to perform an Action.'),
        "descriptionmyturn" => clienttranslate('${you} must choose a location to move a Renown FROM:'),
        "type" => "activeplayer",
        "args" => "argsForState",
        "possibleactions" => [
            "actFromCardWithLocations"
    ...
    States::HIGH_DRAMA_PLAYER_TURN_01189b => [
        ...
        "description" => clienttranslate('${actplayer} is choosing options to perform an Action.'),
        "descriptionmyturn" => clienttranslate('${you} must choose a location to move a Renown TO:'),
        "type" => "activeplayer",
        "args" => "argsForState",
        "possibleactions" => [
            "actFromCardWithLocations"
...
States::HIGH_DRAMA_PLAYER_TURN_01194 => [
    ...
    States::DUEL_RESOLVE_MANEUVER_01051 => [
        ...
        "description" => clienttranslate('${actplayer} is choosing their Duel Action options.'),
        "descriptionmyturn" => clienttranslate('Answering the Call') . clienttranslate(': ${you} must choose a Mercenary to take wounds instead:'),
        "type" => "activeplayer",
        "args" => "argsForStatePrivate",
        "possibleactions" => [
            "actFromCardWithId", 
