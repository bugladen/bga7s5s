# add-new-state-choose-location

## Overview

Will create a new GameState class and add supporting entries to other files. The purpose of which is to choose a location in the game.
...
1. Use the pattern of the entire class from `modules\php\States\State_highDramaPhase01093.php`.
...
3. Copy the exact pattern used for the entry `highDramaPhase01093`.
