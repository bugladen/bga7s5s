 ...
 * -----
 *
 * seventhseacityoffivesails.action.php
 *
 * SeventhSeaCityOfFiveSails main action entry point
 *
 *
...
/**
 * @property SeventhSeaCityOfFiveSails $game
 */
class action_seventhseacityoffivesails extends APP_GameAction
{
    /**
    ...
    public function __default()
    {
        ...
        {
            $this->view = "seventhseacityoffivesails_seventhseacityoffivesails";
