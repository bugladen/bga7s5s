...
| **`<b>Gambling Technique:</b>`** / **`<b>Gambling Maneuver:</b>`** | Pattern E + **Gambling gate** — NOT a trait gate. Always gate **both** `Game::IN_DUEL` and `Game::DUEL_GAMBLED` (actor gambled this round). See Pattern E and `_03043` / `Technique_03002` / `Maneuver_03008` / `_03064`. |
