...
| [pattern-b.md](pattern-b.md) | plain Action / B.1 / B.2 RiskAttachment equip / B.3 En Garde Action forced-enemy challenge / B.4 sink discard + draw + sink self / B.5 Target adjacent enemy → move performer → filtered multi-discard |
