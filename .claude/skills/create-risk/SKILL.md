...
| File | Read when |
|---|---|
| [pattern-a.md](pattern-a.md) | City Action / A.1–A.4 |
| [pattern-b.md](pattern-b.md) | plain Action / B.1 |
| [pattern-c.md](pattern-c.md) | Maneuver / C.1–C.6 |
...
1. Walk each printed Text clause → exactly one pattern (see shape table). Parse literal wording traps (they/you claim, wound participant vs adversary, intervene ≠ ChallengeAccepted, etc.) before copying a mirror.
