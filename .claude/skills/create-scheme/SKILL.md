...
| **`<b>Strega Reaction:</b>`** / **`<b>Mercenary City Action:</b>`** / **`<b>Diplomat …:</b>`** / **`<b>Musketeer …:</b>`** / **`<b>Hero …:</b>`** / **`<b>Villain …:</b>`** / **`<b>Scoundrel …:</b>`** | Trait-prefixed keywords are **mechanical performer-trait gates**, NOT Sorcerer abilities. The chosen performer must have that trait (enforce via `hasTrait("Strega")` / `"Hero"` / `"Villain"` / `"Scoundrel"` etc.). Do NOT `implement ISorcererAbility` for these. Reference: `_03006` (Strega), `_03061` (Hero), `_03062` (Villain), `_03063` (Scoundrel). |
